...
```json
"builder": {
  "id": "https://github.com/root-de/slsa-github-generator/.github/workflows/builder_go_slsa3.yml@refs/tags/v0.0.1"
}
```
...
- [Golang BuildConfig Format](https://github.com/root-de/slsa-github-generator/blob/main/internal/builders/go/README.md#buildconfig-format).
